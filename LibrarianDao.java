...
public class LibrarianDao {
	...
	public static int save(String name,String password,String email,String address,String city,String contact){
		...
		try{
			...
			//PreparedStatement ps=con.prepareStatement("insert into librarian(name,password,email,address,city,contact) values('rajani','rajani','raj@gmail.com','mathura','mathura',90)");
			ps.setString(1,name);
